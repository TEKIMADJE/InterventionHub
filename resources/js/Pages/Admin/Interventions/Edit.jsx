...
export default function Edit({
    ...
    return (
        <>
            <Head
                title={`Modifier ${intervention.reference}`}
            />
                ...
                <section className="flex flex-col gap-4 rounded-2xl bg-gradient-to-r from-blue-700 to-indigo-700 p-5 text-white shadow-lg sm:flex-row sm:items-center sm:justify-between">
                    <div className="min-w-0">
                        ...
                        <p className="mt-1 text-sm text-blue-100">
                            Mettez à jour les informations, la
                            classification et l’affectation.
                        </p>
                    </div>
                        ...
                        <div className="grid gap-5 lg:grid-cols-2">
                            ...
                            <div className="lg:col-span-2">
                                ...
                                <textarea
                                    ...
                                    placeholder="Décrivez précisément la demande..."
                                    className={`${fieldClass(
                                        'description'
                                    )} resize-y`}
                                />
                    ...
                    <section className="p-5 sm:p-6">
                        <div className="mb-5 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-500">
                                    Affectation, catégorie, priorité
                                    et statut
                                </p>
                            </div>
                        </div>
